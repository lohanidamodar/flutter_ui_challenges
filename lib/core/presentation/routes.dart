...
final List<dynamic> pages = [
  menu.MenuItem(title: "Animations", icon: FontAwesomeIcons.truckMoving, items: [
    ...
    menu.SubMenuItem("Animated List One", AnimatedListOnePage(),
  ...
  menu.MenuItem(title: "Profile", icon: Icons.person, items: [
    ...
    menu.SubMenuItem("Profile Nine", ProfileNinePage(), path: ProfileNinePage.path),
    menu.SubMenuItem("Profile One", ProfileOnePage(), path: ProfileOnePage.path),
    menu.SubMenuItem("Profile Two", ProfileTwoPage(), path: ProfileTwoPage.path),
    menu.SubMenuItem("Profile Three", ProfileThreePage(),
        path: ProfileThreePage.path),
    menu.SubMenuItem("Profile Four", ProfileFourPage(), path: ProfileFourPage.path),
    menu.SubMenuItem("Profile Five", ProfileFivePage(), path: ProfileFivePage.path),
    menu.SubMenuItem("Profile Six", ProfileSixPage(sid), path: ProfileSixPage.path),
  ...
  menu.MenuItem(title: "Authentication", icon: Icons.lock, items: [
    menu.SubMenuItem("Login 14", LoginPageFourteen(), path: LoginPageFourteen.path),
    ...
    menu.SubMenuItem("Login Three", LoginThreePage(), path: LoginThreePage.path),
    ...
    menu.SubMenuItem("Login Seven", LoginSevenPage(), path: LoginSevenPage.path),
    menu.SubMenuItem("Login Eight", LoginEightPage(), path: LoginEightPage.path),
    ...
    menu.SubMenuItem("Signup Three", SignupThreePage(), path: SignupThreePage.path),
  ]),
  menu.MenuItem(title: "Settings", icon: Icons.dashboard, items: [
    menu.SubMenuItem("Settings One", SettingsOnePage(), path: SettingsOnePage.path),
    menu.SubMenuItem("Settings Two", SettingsTwoPage(), path: SettingsTwoPage.path),
    menu.SubMenuItem("Settings Three", SettingsThreePage(),
        path: SettingsThreePage.path),
   menu.SubMenuItem("Profile Setting", ProfileSettingsPage(), path: ProfileSettingsPage.path),
    menu.SubMenuItem("Settings Four", SettingsFourPage(), path: SettingsFourPage.path),
  ]),
  menu.MenuItem(
    title: "Quotes App",
    icon: FontAwesomeIcons.quoteLeft,
    items: [
      menu.SubMenuItem("Quote Page Two", QuotesPageTwo(), path: QuotesPageTwo.path),
      menu.SubMenuItem("Quote Page One", QuotesOnePage(), path: QuotesOnePage.path),
    ],
  ),
  menu.MenuItem(title: "Motorbike App", icon: Icons.list, items: [
    menu.SubMenuItem("MoterBike Shop Page", MoterBikeShopPage(), path: MoterBikeShopPage.path),
  ...
  menu.MenuItem(title: "Ecommerce", icon: Icons.shopping_basket, items: [
    ...
    menu.SubMenuItem("Checkout One", CheckoutOnePage(), path: CheckoutOnePage.path),
    ...
    menu.SubMenuItem("Ecommerce Cart One", CartOnePage(), path: CartOnePage.path),
  ...
  menu.MenuItem(title: "Blog", icon: Icons.pages, items: [
    menu.SubMenuItem("News Home", NewsHomeOnePage(), path: NewsHomeOnePage.path),
    menu.SubMenuItem("Sports News Home", SportsNewsOnePage(),
        path: SportsNewsOnePage.path),
    menu.SubMenuItem("Blog Home One", BlogHomeOnePage(), path: BlogHomeOnePage.path),
    menu.SubMenuItem("Article One", ArticleOnePage(), path: ArticleOnePage.path),
    menu.SubMenuItem("Article Two", ArticleTwoPage(), path: ArticleTwoPage.path),
  ]),
  ...
  menu.MenuItem(title: "Food", icon: Icons.fastfood, items: [
    ...
    menu.SubMenuItem("Fruits Add to Cart", AvocadoPage(), path: AvocadoPage.path),
    menu.SubMenuItem("Cake Details", CakePage(), path: CakePage.path),
    menu.SubMenuItem("Recipe List", RecipeListPage(), path: RecipeListPage.path),
  ...
  menu.MenuItem(title: "Todo", icon: FontAwesomeIcons.tasks, items: [
    ...
    menu.SubMenuItem("Todo Home One", TodoHomeOnePage(), path: TodoHomeOnePage.path),
    menu.SubMenuItem("Todo Home Two", TodoHomeTwoPage(), path: TodoHomeTwoPage.path),
  ]),
  menu.MenuItem(title: "Travel", icon: Icons.airplanemode_active, items: [
    menu.SubMenuItem("Travel Home", TravelHomePage(), path: TravelHomePage.path),
    menu.SubMenuItem("Travel Nepal", TravelNepalPage(), path: TravelNepalPage.path),
  ...
  menu.MenuItem(title: "Navigation", icon: Icons.menu, items: [
    ...
    menu.SubMenuItem("Hidden Menu", HiddenMenuPage(), path: HiddenMenuPage.path),
  ...
  menu.MenuItem(title: "Onboarding", icon: Icons.info, items: [
    ...
    menu.SubMenuItem("Landing Page", LandingOnePage(), path: LandingOnePage.path),
    ...
    menu.SubMenuItem("Onboarding 3", IntroThreePage(), path: IntroThreePage.path),
  ...
  menu.MenuItem(
      ...
      items: [
        ...
        menu.SubMenuItem("Furniture App", FurnitureApp(), path: FurnitureApp.path),
      ],
      icon: Icons.account_balance_wallet),
  menu.MenuItem(title: "Miscellaneous", items: [
    menu.SubMenuItem("Youtube HomePage", YoutubeHomePage(), path: YoutubeHomePage.path),
    ...
    menu.SubMenuItem("Gallery One", GalleryPageOne(), path: GalleryPageOne.path),
    menu.SubMenuItem("Music Player Two", MusicPlayerTwoPage(),
        path: MusicPlayerTwoPage.path),
    menu.SubMenuItem("Image Popup", ImagePopupPage(), path: ImagePopupPage.path),
    menu.SubMenuItem("Chat Messaages", ChatTwoPage(), path: ChatTwoPage.path),
    menu.SubMenuItem("Form Elements", FormElementPage(), path: FormElementPage.path),
    ...
    menu.SubMenuItem('Discovery Page', DiscoveryPage(), path: DiscoveryPage.path),
    menu.SubMenuItem('Music player', MusicPlayer(), path: MusicPlayer.path),
    menu.SubMenuItem('Whatsapp Clone', WhatsAppClone(), path: WhatsAppClone.path),
  ]),
];
