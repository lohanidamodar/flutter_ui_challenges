...
class _MainMenuState extends State<MainMenu> {
  ...
  List<Widget> _buildSubMenus(List<menu.SubMenuItem> items, BuildContext context) {
  ...
  void _openPage(BuildContext context, menu.SubMenuItem item, menu.OpenMode mode) {
    Navigator.push(
        context,
        MaterialPageRoute(
