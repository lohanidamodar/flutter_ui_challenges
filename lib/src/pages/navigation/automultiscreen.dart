...
class AutoMultiScreenPage extends StatefulWidget {
    static final String path = "lib/src/pages/navigation/automultiscreen.dart";
  @override
  _AutoMultiScreenPageState createState() => _AutoMultiScreenPageState();
}

class _AutoMultiScreenPageState extends State<AutoMultiScreenPage>
