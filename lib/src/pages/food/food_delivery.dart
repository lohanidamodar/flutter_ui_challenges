            ...
            Expanded(
              child: Padding(
                ...
                child: ListView(
                  scrollDirection: Axis.horizontal,
                  children: <Widget>[
                    FadeAnimation(1.6, makeItem(image: 'https://cdn.pixabay.com/photo/2017/08/06/06/43/pizza-2589575__340.jpg')),
                    FadeAnimation(1.5, makeItem(image: 'https://cdn.pixabay.com/photo/2014/07/08/12/34/pizza-386717__340.jpg')),
                    FadeAnimation(1.6, makeItem(image: 'https://cdn.pixabay.com/photo/2016/09/15/19/24/salad-1672505__340.jpg')),
                  ],
                ),
              ),
            ),
  ...
  Widget makeCategory({isActive, title}) {
    return AspectRatio(
      ...
      child: Container(
        ...
        child: Align(
          child: Text(title, style: TextStyle(color: isActive ? Colors.white : Colors.grey[900], fontSize: 18, fontWeight: isActive ? FontWeight.bold : FontWeight.w100),),
        ),
      ),
    );
  }
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      Text("\$ 20.00", style: TextStyle(color: Colors.white, fontSize: 30, fontWeight: FontWeight.bold),),
                      SizedBox(height: 10,),
